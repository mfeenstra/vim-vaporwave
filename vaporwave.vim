 ...
 " Vaporwave
 " ==================================================================================
 " Vaporwave -- hues of violets and blues
 "   -> cp vaporwave.vim ~/.vimrc/colors && echo 'colorscheme vaporwave' >> ~/.vimrc
 " 2022 - matt.a.feenstra@gmail.co
 " ==================================================================================
 ...
 hi Comment  guibg=bg      guifg=#808080  gui=none  ctermbg=bg   ctermfg=60

 hi Constant    guibg=bg    guifg=#00875f    ctermbg=bg   ctermfg=30
 hi String      guibg=bg    guifg=#875fff    ctermbg=bg   ctermfg=25
 hi Character   guibg=bg    guifg=#5faf87    ctermbg=bg   ctermfg=72
 hi Number      guibg=bg    guifg=#00875f    ctermbg=bg   ctermfg=215
 hi Boolean     guibg=bg    guifg=#00875f    gui=none     ctermbg=bg   ctermfg=210
 hi Float       guibg=bg    guifg=#00875f    ctermbg=bg   ctermfg=3

 hi Identifier  guibg=bg    guifg=#0000ff      ctermbg=bg  ctermfg=105
 hi Function    guibg=bg    guifg=#0000ff      ctermbg=bg  ctermfg=172
 ...
 hi Operator    guibg=bg    guifg=#8a8a8a      ctermbg=bg   ctermfg=201
 hi Keyword     guibg=bg    guifg=#5f005f      ctermbg=bg  ctermfg=175
 hi Exception   guibg=bg    guifg=#5f00af      ctermbg=bg  ctermfg=161

 hi PreProc    guibg=bg   guifg=#0087af  ctermbg=bg  ctermfg=31
 hi Include    guibg=bg   guifg=#0087ff   ctermbg=bg ctermfg=128
 ...
 hi Delimiter  guifg=#008787      guibg=bg      ctermfg=171 ctermbg=bg
